 ...
 * @Version: V1.0
 */
public interface CertchildYpscStMapper extends BaseMapper<CertchildYpscSt> {
   ...
   */
	public List<CertchildYpscSt> selectByMainId(@Param("mainId") String mainId,@Param("glid") String glid);
}
