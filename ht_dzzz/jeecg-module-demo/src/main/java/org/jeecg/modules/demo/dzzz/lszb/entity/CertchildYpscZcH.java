 ...
 */
@Data
@TableName("certchild_ypsc_zc_h")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="certchild_ypsc_zc_h对象", description="certchild_ypsc_zc_h")
public class CertchildYpscZcH implements Serializable {
    ...
    private java.util.Date gzqr;
	/**前置库子表id*/
	@Excel(name = "前置库子表id", width = 15)
    @ApiModelProperty(value = "前置库子表id")
    private java.lang.String zkgid;
	/**同步标识*/
	...
	/**证书oldid*/
	@Excel(name = "证书oldid", width = 15)
    @ApiModelProperty(value = "证书oldid")
