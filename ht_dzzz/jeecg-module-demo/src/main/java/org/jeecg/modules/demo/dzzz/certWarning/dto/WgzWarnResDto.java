...
@Data
@ApiModel(description="证书-未盖章预警-响应数据")
public class WgzWarnResDto implements Serializable {
    ...
    @Excel(name = "发证日期", width = 12)
    @ApiModelProperty(value = "发证日期", dataType = "String")
    private String fzrq;

    @Excel(name = "超时天数", width = 12)
    @ApiModelProperty(value = "超时天数", dataType = "Integer")
    private Integer csDays;
