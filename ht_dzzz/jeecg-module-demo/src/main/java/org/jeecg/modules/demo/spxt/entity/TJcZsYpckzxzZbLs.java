 ...
 */
@Data
@TableName("t_jc_zs_ypckzxz_zb_ls")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="t_jc_zs_ypckzxz_zb_ls对象", description="t_jc_zs_ypckzxz_zb_ls")
public class TJcZsYpckzxzZbLs implements Serializable {
