 ...
 */
@Data
@TableName("t_jc_zs_ypscxk_st_ls")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="t_jc_zs_ypscxk_st_ls对象", description="t_jc_zs_ypscxk_st_ls")
public class TJcZsYpscxkStLs implements Serializable {
