...
export const superQuerySchema = {
  ...
  productionscope: {title: 'productionscope',order: 13,view: 'text', type: 'string',},
  productionscopef: {title: 'productionscopef',order: 14,view: 'text', type: 'string',},
  ...
  zsid: {title: 'zsid',order: 22,view: 'text', type: 'string',},
  createtime: {title: 'createtime',order: 23,view: 'date', type: 'string',},
  gzrq: {title: 'gzrq',order: 24,view: 'date', type: 'string',},
  productionscopecode: {title: 'productionscopecode',order: 25,view: 'text', type: 'string',},
  regnumbvalidate: {title: 'regnumbvalidate',order: 26,view: 'date', type: 'string',},
  hfrq: {title: 'hfrq',order: 27,view: 'date', type: 'string',},
  xzspid: {title: 'xzspid',order: 28,view: 'text', type: 'string',},
  ggflag: {title: 'ggflag',order: 29,view: 'text', type: 'string',},
  isgmp: {title: 'isgmp',order: 30,view: 'text', type: 'string',},
  throughput1: {title: 'throughput1',order: 31,view: 'text', type: 'string',},
  preparationnumber1: {title: 'preparationnumber1',order: 32,view: 'text', type: 'string',},
  sync: {title: 'sync',order: 33,view: 'text', type: 'string',},
  num: {title: 'num',order: 34,view: 'text', type: 'string',},
};
