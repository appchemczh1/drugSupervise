 ...
 */
@Data
@TableName(value = "t_yw_zs",schema = "YJJXZSPXT")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="t_yw_zs_n对象", description="t_yw_zs_n")
public class TYwZsN implements Serializable {
    ...
    private java.lang.String sjtbZsgs;
	/**sjtbDa*/
