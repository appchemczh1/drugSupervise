 ...
 */
@Data
@TableName(value = "t_jc_zs_ypscxk_wt",schema = "YJJXZSPXT")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="t_jc_zs_ypscxk_wt_ls2对象", description="t_jc_zs_ypscxk_wt_ls2")
public class TJcZsYpscxkWtLs2 implements Serializable {
