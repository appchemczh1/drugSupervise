 ...
 */
@Data
@TableName(value = "t_jc_zs_ypscxk_gmp",schema = "YJJXZSPXT")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="t_jc_zs_ypscxk_gmp_ls2对象", description="t_jc_zs_ypscxk_gmp_ls2")
public class TJcZsYpscxkGmpLs2 implements Serializable {
