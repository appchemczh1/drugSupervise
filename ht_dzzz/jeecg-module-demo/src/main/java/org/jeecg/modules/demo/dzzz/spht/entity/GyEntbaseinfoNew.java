 ...
 */
@Data
@TableName(value = "gy_entbaseinfo",schema = "YJJXZSPXT")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="gy_entbaseinfo对象", description="gy_entbaseinfo")
public class GyEntbaseinfoNew implements Serializable {
    ...
    private String id;
	/**entzzjgdm*/
	@Excel(name = "entzzjgdm", width = 15)
    @ApiModelProperty(value = "entzzjgdm")
