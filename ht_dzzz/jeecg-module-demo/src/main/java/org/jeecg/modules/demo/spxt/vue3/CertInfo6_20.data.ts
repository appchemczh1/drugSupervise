...
export const superQuerySchema = {
  ...
  fzrq: {title: '发证日期',order: 15,view: 'text', type: 'string',},
  yxqq: {title: '有效期起',order: 16,view: 'text', type: 'string',},
  yxqz: {title: '有效期至',order: 17,view: 'text', type: 'string',},
  ...
  dzzzid: {title: '电子证照标识',order: 98,view: 'text', type: 'string',},
  yxzt: {title: '证书状态10有效50注销60过期70吊销80撤销99作废',order: 99,view: 'text', type: 'string',},
  attach: {title: '附件存放',order: 100,view: 'text', type: 'string',},
  fileupload: {title: '审批附件',order: 101,view: 'text', type: 'string',},
  ewm: {title: '二维码',order: 102,view: 'text', type: 'string',},
  synctime: {title: 'synctime',order: 103,view: 'date', type: 'string',},
  zsid: {title: 'zsid',order: 104,view: 'text', type: 'string',},
};
