 ...
 */
@Data
public class ZsYwxxbdrop extends ACertInfoIsType {
    ...
    private String zsid;
	/**isxt*/
	@Excel(name = "isxt", width = 15)
    @ApiModelProperty(value = "isxt")
    private String isxt;
    @ApiModelProperty(value = "isType")
    private String  isType;

    @ApiModelProperty(value = "certtypename")
