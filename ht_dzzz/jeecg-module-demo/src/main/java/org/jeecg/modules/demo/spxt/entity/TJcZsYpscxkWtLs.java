 ...
 */
@Data
@TableName("t_jc_zs_ypscxk_wt_ls")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="t_jc_zs_ypscxk_wt_ls对象", description="t_jc_zs_ypscxk_wt_ls")
public class TJcZsYpscxkWtLs implements Serializable {
