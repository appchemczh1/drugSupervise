package org.jeecg.modules.demo.dzzz.certmatadataversion.vo;
 ...
 */
@Data
@ApiModel(value="cert_metadata_versionPage对象", description="证书元数据版本")
public class CertMetadataVersionPage {
	...
	@ExcelCollection(name="证书元数据表")
	@ApiModelProperty(value = "证书元数据表")
	private List<CertMetadata> certMetadataList;
