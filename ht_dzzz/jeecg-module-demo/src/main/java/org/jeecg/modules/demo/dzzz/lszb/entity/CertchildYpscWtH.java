 ...
 */
@Data
@TableName("certchild_ypsc_wt_h")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="certchild_ypsc_wt_h对象", description="certchild_ypsc_wt_h")
public class CertchildYpscWtH implements Serializable {
	...
	/**核减时间*/
	@Excel(name = "核减时间", width = 15)
    @ApiModelProperty(value = "核减时间")
    private java.lang.String gzrq;
	/**protypebak*/
	@Excel(name = "protypebak", width = 15)
    @ApiModelProperty(value = "protypebak")
