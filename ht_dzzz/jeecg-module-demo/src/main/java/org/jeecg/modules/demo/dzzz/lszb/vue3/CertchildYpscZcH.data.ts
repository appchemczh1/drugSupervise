...
export const superQuerySchema = {
  ...
  bgqid: {title: '变更前Id',order: 20,view: 'text', type: 'string',},
  addrdetail: {title: '生产地址详情',order: 21,view: 'text', type: 'string',},
  zsid: {title: '证书id',order: 22,view: 'text', type: 'string',},
  createtime: {title: '创建日期',order: 23,view: 'text', type: 'string',},
  gztime: {title: '盖章日期',order: 24,view: 'text', type: 'string',},
  productionscopecode: {title: '生产范围正本code',order: 25,view: 'text', type: 'string',},
  xzspid: {title: '行政审批id',order: 26,view: 'text', type: 'string',},
  gghjstatus: {title: '公告环节状态“1许可 2不予许可”',order: 27,view: 'text', type: 'string',},
  isgmp: {title: '有无药品gmp证书编号',order: 28,view: 'text', type: 'string',},
  sfsc: {title: '信息状态  0正常 1删除',order: 29,view: 'text', type: 'string',},
  num: {title: '数量',order: 30,view: 'text', type: 'string',},
  regnumevalidate: {title: '某时间',order: 31,view: 'text', type: 'string',},
  zt: {title: '状态 0失效 1有效 2变更',order: 32,view: 'text', type: 'string',},
  sclb: {title: '生产类别',order: 33,view: 'text', type: 'string',},
  gzqr: {title: '核减时间',order: 34,view: 'datetime', type: 'string',},
  zkgid: {title: '前置库子表id',order: 35,view: 'text', type: 'string',},
  sync: {title: '同步标识',order: 36,view: 'text', type: 'string',},
  jhzt: {title: '交换状态',order: 37,view: 'text', type: 'string',},
  zsoldid: {title: '证书oldid',order: 38,view: 'text', type: 'string',},
  ylzd1: {title: 'ylzd1',order: 39,view: 'text', type: 'string',},
  ylzd2: {title: 'ylzd2',order: 40,view: 'text', type: 'string',},
  ylzd3: {title: 'ylzd3',order: 41,view: 'text', type: 'string',},
  ylzd4: {title: 'ylzd4',order: 42,view: 'text', type: 'string',},
  ylzd5: {title: 'ylzd5',order: 43,view: 'text', type: 'string',},
};
