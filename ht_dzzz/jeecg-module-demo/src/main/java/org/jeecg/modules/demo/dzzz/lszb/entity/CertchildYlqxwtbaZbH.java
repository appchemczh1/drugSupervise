 ...
 */
@Data
@TableName("certchild_ylqxwtba_zb_h")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="certchild_ylqxwtba_zb_h对象", description="certchild_ylqxwtba_zb_h")
public class CertchildYlqxwtbaZbH implements Serializable {
