<template>
    ...
    >
      ...
      <div class="jeecg-basic-table-form-container" v-if="showSearchFlag">
        ...
        <a-button preIcon="ion:layers-outline"
                  style="z-index: 9999;float: left;margin-top: 0px;margin-right: 10px;background-color: #0a8fe9;color: azure;"
  ...
  <InformationModal @register="registerModaldatast" @success="handleSucce"></InformationModal>
...
export default defineComponent({
  ...
  components: {
    //此处需要异步加载BasicTable
    BasicModal,
    InformationModal:createAsyncComponent(() => import('../../../../../../views/dzzz/information/components/InformationModal.vue'), { loading: false }),
