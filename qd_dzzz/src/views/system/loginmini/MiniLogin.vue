<template>
  <div :class="prefixCls"  class="login-background-img">
    <div v-show="type === 'login'">
      <div style="font-size: 22px; color:white; padding-left: 24%;padding-top: 7%;">
        <h1 style="font-weight: bold; text-shadow: 4px 4px 10px #222222;">电 子 证 书 管 理 系 统</h1>
        <h1 style="font-size: 20px;">Electronic Certificate Management System</h1>
      </div>  
      <div class="aui-content">
        <div class="aui-container" >
          <div class="aui-form">
            ...
            <div class="aui-formBox" style="width: 350px; border-radius:20px;  background-color: aliceblue;">
              <div class="aui-formWell">
                <div style="font-size: 24px">欢迎登录</div>
                <div class="aui-form-box" style="height: 180px; border-radius:20px;">
          ...
          <!-- <div class="aui-form" style="width: 950px;border-radius:15px;">
...
<script lang="ts" setup name="login-mini">
  ...
  import adTextImg from '/@/assets/loginmini/icon/denglutuyang.png';
