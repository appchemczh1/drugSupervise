...
<script lang="ts" setup>
    ...
    //渲染流程表单数据
    const queryByIdUrl = '/dzzz/certMetadataVersion/queryById';
    async function initFormData(){
      if(props.formBpm === true){
        ...
        requestSubTableData(queryCertMetadata, {id: data.id}, certMetadataTable, ()=>{
          certMetadataTable.show = true;
        });
        // 隐藏底部时禁用整个表单
