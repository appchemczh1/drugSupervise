...
<script lang="ts" setup>
    ...
    import {formSchema,certMetadataColumns} from '../CertMetadataVersion.data';
    import {saveOrUpdate,certMetadataList} from '../CertMetadataVersion.api';
    ...
    const [registerModal, {setModalProps, closeModal}] = useModalInner(async (data) => {
        ...
        if (unref(isUpdate)) {
            ...
            await setFieldsValue({
             ...
             requestSubTableData(certMetadataList, {id:data?.record?.id}, certMetadataTable)
        }
        // 隐藏底部时禁用整个表单
