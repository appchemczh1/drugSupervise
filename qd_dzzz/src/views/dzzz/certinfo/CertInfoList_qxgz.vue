...
<!--        <a-dropdown v-if="selectedRowKeys.length > 0">
        ...
        <a-button type="primary" @click="btngz" :loading="loading" preIcon="ant-design:plus-outlined">批量取消盖章</a-button>
        <!-- 高级查询 -->
...
<!--        <TableAction :actions="getTableAction(record)" />-->
    ...
    <!-- 表单区域 -->
    <CertInfoModal @register="registerModal" :zt="4" @success="handleSuccess"></CertInfoModal>
...
import {
  ...
  getcertmetelist,
  certmetelist,
  generate_gz_cert, getAttachByCertid, cancleGz
} from './CertInfo.api';
 ...
 function  btngz()
{
  ...
  createConfirm({
    ...
    onOk: () => {
      loading.value=true;
       cancleGz({ids: selectedRowKeys.value},handleSuccessbutton);
