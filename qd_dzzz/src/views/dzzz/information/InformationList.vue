<template>
  <div>
    ...
    <!-- 表单区域 -->
    <informationModal @register="registerModal" @success="handleSuccess"></informationModal>
  </div>
</template>

<script lang="ts" name="dzzz.information-information" setup>
  import { ref, reactive, computed, unref } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useModal } from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage';
  import informationModal from './components/informationModal.vue';
  import { columns, searchFormSchema, superQuerySchema } from './information.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './information.api';
