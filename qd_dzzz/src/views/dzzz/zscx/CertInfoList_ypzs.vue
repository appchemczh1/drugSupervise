...
<!--        <TableAction_ZDY :actions="getTableActionyl(record)" :drop-down-actions="getDynamicDropDownActions(record)" />-->
...
<script lang="ts" name="dzzz.certinfo-certInfo" setup>
  ...
  import CertInfoModal from '../certinfo/components/CertInfoModal.vue';
  import readermodel from '../certinfo/components/readermodel.vue';
  import { columnsZscx, searchFormSchema, searchFormSchemaypzs, superQuerySchema } from '../certinfo/CertInfo.data';
