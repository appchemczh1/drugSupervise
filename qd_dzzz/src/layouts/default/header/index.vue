<template>
  <Header :class="getHeaderClass">
    ...
    <div :class="`${prefixCls}-left`">
      ...
      <!--      &lt;!&ndash;      <LayoutTrigger&ndash;&gt;-->
      <!--      &lt;!&ndash;        v-if="(getShowContent && getShowHeaderTrigger && !getSplit && !getIsMixSidebar) || getIsMobile"&ndash;&gt;-->
      <!--      &lt;!&ndash;        :theme="getHeaderTheme"&ndash;&gt;-->
      <!--      &lt;!&ndash;        :sider="false"&ndash;&gt;-->
      <!--      &lt;!&ndash;      />&ndash;&gt;-->
...
<style lang="less">
  ...
  // Add custom background image to the header
  .ant-layout .@{prefix-cls} {
    background-color: #2f75e1 !important;
    background-image: url('@/layouts/default/header/header2.png') !important;
    background-size: contain !important; /* Adjust to fit the image while preserving its aspect ratio */
    background-position: top left !important; /* Align the image to the top and center horizontally */
