...
console.log(PAGE_NOT_FOUND_ROUTE);
console.log(123);
...
export const GsptRoute: AppRouteRecordRaw = {
  path: '/licenseInfo',
  name: 'licenseInfo',
  //新版后台登录，如果想要使用旧版登录放开即可
  component: () => import('/@/views/dzzz/certmulu/zsml_gspt3.vue'),
  meta: {
    title: '',
  },
};
...
export const basicRoutes = [LoginRoute, RootRoute, ...mainOutRoutes, REDIRECT_ROUTE, PAGE_NOT_FOUND_ROUTE, TokenLoginRoute, Oauth2LoginRoute,GsptRoute];
