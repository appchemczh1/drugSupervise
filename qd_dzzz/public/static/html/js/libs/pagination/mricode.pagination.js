...
(function(factory) {
    ...
    Page.prototype = {
        ...
        initHtml: function() {
            ...
            //init jump module
            var jumpHtml = '<div class="m-pagination-group"><p>前往第</p><input data-page-btn="jump" type="text"><p>页</p><button data-page-btn="jump" type="button">' + this.options.jumpBtnText + '</button></div>';
